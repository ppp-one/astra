...
#. Follow the terminal instructions
   ...
   * This will create a directory structure for your observatory assets (configuration files, schedules, logs, images) in the specified path.
   * The configuration files will be created in the ``observatory_config`` directory which you need to edit with your observatory's information before using Astra under normal operation. Please see here: :doc:`observatory configuration <user_guide/configuration>`.
...
#. Open your web browser and navigate to the following URL http://localhost:8000
